...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        router.replace('/onboarding'); // ✅ Goes to onboarding after login
      } else {
  ...
  return (
    <View style={styles.container}>
      {/* ✅ Logo/Image */}
      <Image
        source={require('@/assets/images/ziplanfulllogo.png')} // replace with your image path
        style={styles.logo}
        resizeMode="contain"
      />

      <Text style={styles.title}>Login to Ziplan</Text>
      ...
      <TouchableOpacity onPress={() => router.push('/signup')}>
        <Text style={styles.switchText}>First time user? Sign up here</Text>
      </TouchableOpacity>
    </View>
  );
}
